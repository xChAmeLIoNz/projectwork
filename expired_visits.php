                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title">Lista visite scadute</h5>
                            </div>
                            ...
                            <table class="table datatable table-hover">
                                ...
                                <tbody>
                                    ...
                                    JOIN pw_iseppe_medics ON pw_iseppe_visits.id_medic = pw_iseppe_medics.id WHERE DATEDIFF(CURDATE(), date_visit) >= 60 GROUP BY id_visit DESC")) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            if ($query = $mysqli->query("SELECT pw_iseppe_users.telephone
                                                FROM pw_iseppe_users
                                                JOIN pw_iseppe_animals ON pw_iseppe_users.id = pw_iseppe_animals.id_owner
                                                JOIN pw_iseppe_visits ON pw_iseppe_animals.id_animal = pw_iseppe_visits.id_animal
                                                WHERE pw_iseppe_visits.id_visit = " . $row['id_visit'] . "")) {
                                    ...
                                    ?>
                                            ...
                                            <td>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="icon">
                                                        <!-- <span data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit"> -->
                                                        <a href="https://api.whatsapp.com/send?phone=<?php echo $numero['telephone']; ?>&text=Gentile cliente, la informiamo che sono passati 60 giorni dall'ultima visita presso la clinica Iseppos ed è consigliato un richiamo."><button class="btn" type="button"><i class="bi bi-chat-left-dots"></i></button></a>
                                                        <!-- </span> -->
